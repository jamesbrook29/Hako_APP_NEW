...
const ArtWorkRow = (props) => {
    ...
    return (
        <View>
            <TouchableOpacity onPress={props.rowClick}>
                <View style={styles.mainContainer}>
                    <Image resizeMode={'contain'} style={{ height: 28, width: 28, alignSelf: 'center' }} source={require('../../imgs/star_grey.png')} />
                    <Image resizeMode={'contain'} style={{ height: 80, width: 80, alignSelf: 'center', marginLeft: 10 }} source={require('../../imgs/list_items.png')} />
